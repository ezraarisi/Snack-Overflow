	...
	<div class="container-fluid">		
		...
		?>      
			...
			<div class="text-end">
				...
				<a href="cart.php?action=empty">
					<button class="rounded-0 btn "><span class="fa fa-trash"></span> Empty Cart</button></a>

				<a href="index.php"><button class="rounded-0 btn "> <span class="fa fa-plus"></span>Add more</button></a>
				
				<a href="checkout.php"><button class="rounded-0 btn  pull-right"><span class="fa fa-shopping-cart"></span> Check Out</button></a>
		...
		?>
			<div class="container">
				...
				<h3 class='text-center'>Your cart is empty. Explore the <a href="./index.php" class="link-dark">Menu</a>.</h3>        
				</div>      
			</div> 
